      ...
      <main className="flex-1 overflow-y-auto p-8">
        <div className="max-w-3xl mx-auto">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-stone-900">DPIIT Recognition Wizard</h1>
              <p className="text-stone-500 text-sm">Your step-by-step journey to DPIIT recognition.</p>
            </div>
          </div>
          ...
          <div className="glass rounded-2xl p-5 shadow-sm mb-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium text-stone-700">Your DPIIT Journey</span>
            ...
            <div className="h-3 bg-peach-100/50 rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-peach-500 to-green-500 rounded-full transition-all duration-500"
                ...
                return (
                  <div
                    ...
                    className={`glass border rounded-2xl p-6 shadow-sm transition-all ${
                      isDone ? "border-green-200 bg-green-50/30" : "border-peach-200/40"
                    }`}
                  >
                    <div className="flex items-start gap-4">
                      {/* Step number */}
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 text-sm font-bold ${
                        isDone ? "bg-green-500 text-white" : "bg-peach-50/60 text-stone-500"
                      }`}>
                        {isDone ? "✓" : idx + 1}
                      </div>
