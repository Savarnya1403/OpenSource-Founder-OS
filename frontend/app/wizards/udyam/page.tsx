      ...
      <main className="flex-1 p-8">
        <div className="max-w-3xl mx-auto">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Udyam Registration Wizard</h1>
              <p className="text-gray-500 text-sm">Register your enterprise as an MSME in minutes.</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm mb-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium text-gray-700">Your Udyam Journey</span>
              <span className="text-sm font-bold text-brand-600">{doneCount}/{steps.length} steps</span>
            </div>
            <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-blue-500 to-brand-500 rounded-full transition-all duration-500"
                ...
                return (
                  <div
                    ...
                    className={`bg-white border rounded-2xl p-6 shadow-sm transition-all ${
                      isDone ? "border-blue-200 bg-blue-50/20" : "border-gray-100"
                    }`}
                  >
